...
description: How to add the Dub Analytics script to your site using Google Tag Manager
...
<Steps>
  ...
  <Step title="Add the Dub Analytics Script">
    ...
    If you're using [Dub Partners](/docs/partners/quickstart) for affiliate management, you will also need to set up the `data-domains` property to enable [client-side click-tracking](/docs/sdks/client-side/features/click-tracking).
