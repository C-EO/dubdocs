...
1. Obtain your [publishable key](/docs/api-reference/authentication#publishable-keys) (`DUB_PUBLISHABLE_KEY`) from
...
2. (Optional) If you plan to track conversions, follow the [Dub Conversions quickstart guide](/docs/conversions/quickstart) to [enable conversion tracking for your links](/docs/conversions/quickstart#step-1%3A-enable-conversion-tracking-for-your-links).
