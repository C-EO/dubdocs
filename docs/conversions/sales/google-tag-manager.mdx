...
When it comes to [conversion tracking](/docs/conversions/quickstart), a `sale` event happens when a user purchases your product or service. Examples include:
...
<Tip>
  ...
  tracking](/docs/conversions/leads/google-tag-manager), you can skip to Step 2.
</Tip>
...
<Tip>
  If you've already set up the [Dub Analytics script for lead
  tracking](/docs/conversions/leads/google-tag-manager), you can skip this step.
</Tip>
...
<Warning>
  ...
  key](https://dub.co/docs/api-reference/authentication#publishable-keys) from
  your Dub workspace (under the [Analytics settings
