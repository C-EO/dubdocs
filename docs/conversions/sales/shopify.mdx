...
When it comes to [conversion tracking](/docs/conversions/quickstart), a `sale` event happens when a user purchases a product from your Shopify store.
...
1. [On a workspace-level](/docs/conversions/quickstart#option-1-on-a-workspace-level)
2. [On a link-level](/docs/conversions/quickstart#option-2-on-a-link-level)
3. [Via the API](/docs/conversions/quickstart#option-3-via-the-api)
...
With the Shopify app, you can also create [conversion-enabled links](/docs/conversions//quickstart#step-1%3A-enable-conversion-tracking-for-your-links) directly from your Shopify store:
