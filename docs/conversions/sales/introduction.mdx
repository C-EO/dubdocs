...
<Note>
  Looking to track sales without a prior lead event? Check out our [direct sale tracking](/docs/conversions/sales/direct) guide.
</Note>
...
If you're not using any of the providers listed above, you can also manually track sale events using our [native SDKs](/docs/sdks/overview) within your backend code:
