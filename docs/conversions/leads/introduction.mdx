...
1. Within the sign-up API request, retrieve the `dub_id` cookie that was created by the [`@dub/analytics` client-SDK](/docs/sdks/client-side/introduction).
...
Here are some examples of how you can track lead events using our [native SDKs](/docs/sdks/overview):
