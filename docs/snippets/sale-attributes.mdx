...
| `paymentProcessor`   | No       | The payment processor that processed the sale (e.g. [Stripe](/docs/conversions/sales/stripe), [Shopify](/docs/conversions/sales/shopify)). Defaults to "custom". |
