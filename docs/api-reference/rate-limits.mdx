...
- [`GET /events`](/docs/api-reference/analytics/list-events) – retrieving paginated lists of events
...
[Webhooks](/docs/concepts/webhooks/introduction) are _push-based_, meaning that Dub will send events to your webhook receiver endpoint when specific events occur, while a REST API is _pull-based_, meaning that you need to consistently poll the API endpoint to get real-time updates.

Check out our [webhooks documentation](/docs/concepts/webhooks/introduction) to learn more.
