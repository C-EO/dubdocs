...
og:title: "Bulk update links with the Dub API - API Reference"
sidebarTitle: "Bulk update links"
---
...
<Warning>
  ...
  [webhook events](/docs/concepts/webhooks/introduction) will not be triggered when
  using this endpoint.
</Warning>
