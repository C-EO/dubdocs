...
This event is triggered when a [new lead is created](/docs/api-reference/analytics/track-lead) via [Dub Conversions](/docs/conversions/quickstart). The event payload contains the following:
...
This event is triggered when a [new sale is tracked](/docs/api-reference/analytics/track-sale) via [Dub Conversions](/docs/conversions/quickstart). The event payload contains the following:
