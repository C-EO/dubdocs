...
This event is triggered when a [new link is created](/docs/api-reference/links/create) in your Dub workspace. The event payload contains the created link's details.
...
This event is triggered when a [link is updated](/docs/api-reference/links/update) in your Dub workspace. The event payload contains the updated link's details.
...
This event is triggered when a [link is deleted](/docs/api-reference/links/delete) in your Dub workspace. The event payload contains the deleted link's details.
...
This event is triggered when a [new lead is created](/docs/api-reference/conversions/track-lead) via [Dub Conversions](/docs/conversions/quickstart). The event payload contains the following:
...
This event is triggered when a [new sale is tracked](/docs/api-reference/conversions/track-sale) via [Dub Conversions](/docs/conversions/quickstart). The event payload contains the following:
...
This event is triggered when a [new partner is enrolled](/docs/api-reference/partners/create) in your partner program. The event payload contains the following:
...
<Note>
  ...
  guide](/docs/partners/external-payouts).
</Note>
