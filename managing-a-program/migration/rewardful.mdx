...
3. **Advanced reward structures:** On Dub, you can choose between [3 reward types](/managing-a-program/customizing-rewards/customizing-rewards) – per click, per lead, and per sale (flat/percentage). You can also set different reward conditions and create bounties to provide additional rewards for your affiliates.
4. **Payouts you can rely on:** We let you [pay your partners globally](/managing-a-program/sending-payouts/partner-payouts) in 1-click, with tax compliance built-in.
...
Next, [set up conversion tracking](/managing-a-program/getting-started/conversion-tracking) to track signup and sale events. We also have some [in-app guides that you can reference here](https://app.dub.co/guides).
...
Once you've [set up your Dub partner program](/managing-a-program/getting-started/setting-up-your-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from Rewardful".
...
- **Processed:** When a commission has been added to a [payout](/managing-a-program/sending-payouts/partner-payouts) (after any applicable holding period).
...
Dub Partners supports [1-click payouts](/managing-a-program/sending-payouts/partner-payouts) to partners all across the globe. We generally recommend using ACH for partner payouts as it is the most cost-effective option. Here's [how you can set up your bank account](/managing-a-program/sending-payouts/bank-account) for ACH payouts.
