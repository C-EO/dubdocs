...
description: "Learn how to create partner groups to segment partners by rewards, discounts, performance, location, and more."
og:title: "Managing your partners with groups | Dub Help Center"
---
...
<Frame>
  <img
    className="rounded-lg border border-gray-100"
    src="https://assets.dub.co/cms/group-default.png"
    alt="Partner Groups navigation"
  />
</Frame>

<Note>
You cannot delete your default partner group. This group will also be the group that your partners will be reassigned to whenever you delete another partner group.
</Note>
...
<Frame>
  <img
    className="rounded-lg border border-gray-100"
    src="https://assets.dub.co/cms/group-create.png"
    alt="Partner Groups create"
  />
</Frame>

| Field | Description |
| --- | --- |
| **Group name** | Add a name to your group to help easily identify it later. **This name is for internal use only and is never visible to your partners.** |
| **Group color** | Set the color of the group with our simple color picker. |
| **Group slug** | Each partner group uses a unique application landing page, which you can use to share with partners you want to automatically add to that group when they apply. This name is for internal and external use, so anyone you share the application link with can see the slug name provided. |
| **Group ID** | This non-editable item is used for embedding the Dub white-labeled referral dashboard within your app. [Learn more](/partners/embedded-referrals). |
...
<Frame>
  <img
    ...
    alt="Partner Groups rewards"
  />
</Frame>

To create a reward, click **Create** on any of the reward types. Learn more about [creating rewards](/managing-a-program/customizing-rewards/customizing-rewards).
...
You can also create dual-sided incentives for your affiliate/referral programs, which give special discounts to customers who sign up via a referral link. Some examples include:
...
<Frame>
  <img
    ...
    alt="Partner Groups discounts"
  />
</Frame>

You can create only one discount per group. To create a discount, click **Create** on the discount block. Learn more about [creating discounts](/partners/link-based-discounts).
...
By default, the group slug will auto-generate based on the group name, but you're able to change this at any time. Used for program landing pages and internal group page URLs.
...
When setting up the Dub embedded referral dashboard, you'll use this group ID. The ID cannot be changed.

### Payout holding period

Specify how long your commissions will be held in "pending" status before becoming eligible for payout. [Learn more](/managing-a-program/sending-payouts/partner-payouts).

### Auto-approve

Enable or disable auto-approving new applicants to this group. [Learn more](/managing-a-program/recruiting-partners/reviewing-applications).
...
<Frame>
  <img
    ...
    alt="Partner Groups application URL"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="Partner Groups application select group"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="Partner Groups add to group"
  />
</Frame>
...
| Plan | Partner groups |
| --- | --- |
| Business | Up to 3 groups (including Default group) |
| Advanced | Up to 10 groups (including Default group) |
...
<CardGroup cols={2}>
  ...
  <Card title="Reviewing applications" icon="clipboard-check" href="/managing-a-program/recruiting-partners/reviewing-applications" />
