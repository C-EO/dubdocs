...
- [`POST /track/lead`](https://dub.co/docs/api-reference/track/lead)
- [`POST /track/sale`](https://dub.co/docs/api-reference/track/sale)
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="code"
    href="https://dub.co/docs/api-reference/track/lead"
  >
...
Alternatively, you can also send sale events manually using [our SDKs](/docs/sdks/overview) or the [`POST /track/sale` API endpoint](https://dub.co/docs/api-reference/track/sale).
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="code"
    href="https://dub.co/docs/api-reference/track/sale"
  >
