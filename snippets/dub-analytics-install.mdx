<Steps titleSize="h3">
  ...
  <Step title="Optional: Set up client-side click tracking">
    ...
    If you're using [Dub Partners](/docs/partners/quickstart) for affiliate management,  you will also need to set up the `domainsConfig.refer` property to enable [client-side click-tracking](/docs/sdks/client-side/features/click-tracking).
