...
If you're manually tracking a sale event via our `/track/sale` endpoint, you can pass along the product ID via the [metadata prop](/docs/api-reference/conversions/track-sale) (e.g. `metadata.productId = "prod_xxx"`).
...
You can update a [partner group's](/help/getting-started/partner-groups) reward configuration at any time. When this happens, historical commissions won't be updated.
