...
og:title: "Choose a Custom Domain for Short Links"
og:description: "Discover how to select the ideal custom domain for your Dub short links with this guide, ensuring optimal branding & functionality."
---

Custom domains are a great way to [improve the click-through rates of your short links](/blog/custom-domains). They are especially useful if you want to use a domain that is relevant to your audience and content.
...
2. **Length**: Shorter domains are easier to remember and type. To achieve this, some companies might opt for acronyms or abbreviations. For example, one of our customers [Tinybird](/customers/tinybird) uses `tbrd.co` for their short domain.
...
Here are some examples of custom domains that you can use for your short links – based on what we've seen [our customers](/customers) use:
...
<Note>
  At the time of writing, 1,293 out of 4,024 verified domains on Dub.co use a
...
<Note>
  At the time of writing, 266 out of 4,024 verified domains on Dub.co use a
  different TLD for their short links – a 6.6% usage rate.
</Note>

<Tip>
  If you're on a [Pro plan](/help/article/pro-plan) or higher, you can also claim a [complimentary .link custom domain](/help/article/free-dot-link-domain) and use it as your short link domain.
  <br />
...
<Note>
  At the time of writing, 78 out of 4,024 verified domains on Dub.co use a
  domain hack for their short links – a 1.9% usage rate.
</Note>
