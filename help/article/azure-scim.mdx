...
<img src="https://assets.dub.co/cms/scim-entra.png" alt="SCIM Modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/scim-entra-confirm.png" alt="SCIM Modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-tab.png" alt="Provisioning tab of Okta SAML application" className="rounded-lg border border-gray-100" />

In the Provisioning tab, click on **Get started**.

<img src="https://assets.dub.co/help/azure-scim-get-started.png" alt="Get started with provisioning" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-provisioning.png" alt="Provisioning tab of Azure SAML application" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-mappings.png" alt="Mappings section of Azure SAML application" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-settings.png" alt="Settings section of Azure SAML application" className="rounded-lg border border-gray-100" />
