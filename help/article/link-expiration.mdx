---
title: "How to set an expiration date for your Dub.co links?"
description: "Learn how to use automatically expire your Dub.co links after a certain date & time."
og:title: "Set Expiration Date for Your Short Links"
og:description: "Set expiration dates for your Dub links & control access with automated link expiry. Learn how to schedule link deactivation easily."
---
...
<Video
  src="https://assets.dub.co/help/link-expiration-input-demo.mp4"
  className="aspect-[1388/800]"
/>
...
<img src="https://assets.dub.co/cms/expired-link-placeholder.png" alt="Expired link page" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/link-expiration-url.png" alt="Expired link page" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/domain-expiration-url.png" alt="Default expiration URL for a domain" className="rounded-lg border border-gray-100" />
