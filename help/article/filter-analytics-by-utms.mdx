...
<Steps>
     ...
     <Step title="Open Analytics filter dropdown">
        ...
        <Frame>
          <img
            src="https://assets.dub.co/cms/analytics-filter-dropdown-utm.png"
    ...
    <Step title="Select the 'UTM Source' filter option">
        ...
        <Frame>
          <img
            src="https://assets.dub.co/cms/analytics-utm-source-dropdown.png"
    ...
    <Step title="Click on the UTM source you want to filter by">
        ...
        <Frame>
          <img
            src="https://assets.dub.co/cms/filtered-analytics-by-utm.png"
