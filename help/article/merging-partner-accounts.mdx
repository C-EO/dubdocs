...
og:title: "Merging your partner accounts"
og:description: "Learn how to merge one of your partner accounts with another, to keep things organized and better managed."
---
...
<img src="https://assets.dub.co/cms/merge-email-input.jpg" alt="Source and target account emails" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/merge-email.jpg" alt="One-time password email" className="rounded-lg border border-gray-100" />
Enter the OTP for each email address into their required field, and click **Verify accounts** to confirm the codes.
<img src="https://assets.dub.co/cms/merge-account-verification.jpg" alt="Email verification" className="rounded-lg border border-gray-100" />
