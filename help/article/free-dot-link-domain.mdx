...
og:title: "Free .link domain offer on Dub"
og:description: "Learn how to get a 1-year free .link domain on Dub to create short links that match your brand and improve click-through rates."
---
...
This is a great way to get started with [custom domains](/blog/custom-domains) and create short links that match your brand, which gives you [better brand recognition](/blog/custom-domains#better-brand-recognition) and improves click-through rates.

## How to get a free .link domain

To get a free `.link` domain, you need to have a paid plan on Dub ([Pro plan](/help/article/pro-plan) or above). Once you have a paid plan, you can claim your free `.link` domain by following these steps:
...
<img src="https://assets.dub.co/help/claim-dotlink-banner.png" alt="Banner prompting you to claim your free .link domain" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/claim-dotlink-button.png" alt="Claim your free .link domain button" className="rounded-lg border border-gray-100" />

You can also claim your free `.link` domain directly in the onboarding flow:

<img src="https://assets.dub.co/help/claim-domain-onboarding.jpg" alt="Claim your free .link domain" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/search-dotlink-domain-unavailable.png" alt="Search for your .link domain – domain is unavailable" className="rounded-lg border border-gray-100" />

If the domain is available, you'll see a **Claim domain** button. Click on the button to claim your free `.link` domain.

<img src="https://assets.dub.co/help/search-dotlink-domain-available.png" alt="Search for your .link domain – domain is available" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/dotlink-domain-provisioning.png" alt="Provisioning badge" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/dotlink-domain-provisioned.png" alt="Active badge" className="rounded-lg border border-gray-100" />

<Info>
  The provisioning process can take anywhere between a few minutes to an hour. If
  your domain is not active after 1 hour, please [reach out to our support
