...
<img
  ...
  className="rounded-lg border border-gray-100"
/>
### Text Best used for text and paragraph content. This section also uses
markdown formatting when editing. [View markdown styles
available.](https://dub.co/draft/help/article/using-the-program-landing-page-builder#markdown-styles)
<img
  src="https://assets.dub.co/cms/lander-insert-text.jpg"
  alt="Adding text content"
  className="rounded-lg border border-gray-100"
/>
### Image For adding product screenshots and other complementary visuals to the
program.
<img
  ...
  className="rounded-lg border border-gray-100"
/>
### Files For adding product screenshots and other complementary visuals to the
program.
<img
  ...
  className="rounded-lg border border-gray-100"
/>
### Accordion Best used for FAQ sections and other collapsible related content.
This section also uses markdown formatting when editing. [View markdown styles
available.](https://dub.co/draft/help/article/using-the-program-landing-page-builder#markdown-styles)
<img
  ...
  className="rounded-lg border border-gray-100"
/>
### Earnings calculator Give your partners a sense of how much they can earn,
based on your default rewards.
<img
