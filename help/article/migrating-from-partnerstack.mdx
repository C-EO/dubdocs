...
og:title: "Migrating from PartnerStack"
og:description: "Easily migrate your affiliate program from PartnerStack to Dub Partners in just a few clicks."
---
...
1. **Pricing that scales with your success**: You can start your affiliate program on Dub with [as little as $90/month](/pricing/partners) and only 5% payout fees. As you grow, payout fees drop to 3%, giving you the flexibility to reward partners without high costs eating into your margins.
2. **Modern UI with enterprise-grade capabilities**: Dub's modern interface makes it simple for both you and your partners to navigate without a learning curve. You can use our [Embedded Referral Dashboard](https://dub.co/docs/partners/embedded-referrals) to create a seamless referral experience, or leverage our best-in-class [Fraud Detection](/help/article/fraud-detection) suite to ensure the safety/compliance of your program. The possibilities are endless.
...
<img src="https://assets.dub.co/cms/partnerstack-api-key.png" alt="PartnerStack API key" className="rounded-lg border border-gray-100" />
...
Once you've [set up your Dub partner program](https://dub.co/docs/partners/quickstart#step-3%3A-set-up-your-partner-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from PartnerStack".
...
<img src="https://assets.dub.co/cms/import-partnerstack-modal.png" alt="Import PartnerStack modal" className="rounded-lg border border-gray-100" />
...
Feel free to [reach out to support](/contact/support) if you need help manually configuring specific reward groups for your importer partners.
</Info>
...
> Hey,
> 
> Starting today, we are switching the [Your Company] Affiliate Program from PartnerStack to [Dub Partners](https://dub.partners/). 
> 
