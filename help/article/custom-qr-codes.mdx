...
og:title: "Custom QR Codes"
og:description: "Generate & customize QR codes for your short links on Dub. Learn how to enhance branding, track scans & optimize engagement effortlessly."
---
...
<img src="https://assets.dub.co/help/free-plan-qrcode.png" alt="Default QR Code logo on Dub" className="rounded-lg border border-gray-100" />

If you'd like to remove the Dub logo/upload your own, please consider [upgrading to a Pro plan](/help/article/pro-plan#how-to-upgrade-to-pro) to support us. Thank you!
...
<img src="https://assets.dub.co/changelog/custom-qr-codes.png" alt="Custom QR Code logo" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/changelog/custom-qr-code-logo.jpg" alt="Set custom QR code logos for your domains" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/domain-custom-qr-code-logo.png" alt="Setting a custom QR code logo for a custom domain" className="rounded-lg border border-gray-100" />
