...
With Dub, you can turn your short links into end-to-end attribution engines by tracking how your clicks convert to [signups](/docs/conversions/leads/introduction) and [sales](/docs/conversions/sales/introduction).

As part of [lead tracking](/docs/conversions/leads/introduction), Dub creates customer objects to visualize how your users interact with your links and how much they spend on your product.
