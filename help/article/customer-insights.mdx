...
og:title: "Customer Insights"
og:description: "Get deeper, real-time insights about your customers' demographics, purchasing behavior, and lifetime value (LTV)."
---
...
With Dub, you can turn your short links into end-to-end attribution engines by tracking how your clicks convert to [signups](https://dub.co/docs/conversions/leads/introduction) and [sales](https://dub.co/docs/conversions/sales/introduction).

As part of [lead tracking](https://dub.co/docs/conversions/leads/introduction), Dub creates customer objects to visualize how your users interact with your links and how much they spend on your product.
...
<img src="https://assets.dub.co/cms/customer-insights-02.jpg" alt="Customer insights on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/customers-table-02.png" alt="Customers table on Dub" className="rounded-lg border border-gray-100" />

In this table, you can also filter by country or a specific link, or search for a specific customer by their name, email, or [external ID](https://dub.co/docs/api-reference/endpoint/track-lead#body-external-id).
...
<img src="https://assets.dub.co/cms/customer-page-03.png" alt="Customers page on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/customer-page-referral-02.png" alt="Partner referral customer pages on Dub" className="rounded-lg border border-gray-100" />
