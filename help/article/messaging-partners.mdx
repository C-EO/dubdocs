...
<Tip>
  This feature is only available on [Advanced plans and above](/pricing/partners).
</Tip>
...
<img src="https://assets.dub.co/cms/messages-owner-nav.png" alt="Messages location" className="rounded-lg border border-gray-100" />


## Messages overview
The messaging center has three panels:

<img src="https://assets.dub.co/cms/messages-owner-panels.png" alt="Message panels" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/messages-owner-inbox.png" alt="Inbox panel" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/messages-owner-breakdown.png" alt="Inbox pieces" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/messages-owner-conversation-2.png" alt="Conversation panel" className="rounded-lg border border-gray-100" />
#### Message status
...
<img src="https://assets.dub.co/cms/messages-owner-details.png" alt="Details panel" className="rounded-lg border border-gray-100" />
### 
## Disabling messaging
...
<img src="https://assets.dub.co/cms/messages-owner-disable.png" alt="Disable messages" className="rounded-lg border border-gray-100" />
