...
<img
  src="https://assets.dub.co/help/transfer-domain-button.png"
  alt="Transfer domain option"
...
<img
  src="https://assets.dub.co/help/transfer-domain-modal.png"
  alt="Transfer domain modal"
  className="rounded-lg border border-gray-100"
/>
