...
og:title: "How do I add UTM parameters to a link?"
og:description: "Learn more about why UTM parameters are important for marketing links and how to add them to your links using the Dub UTM Builder."
---
...
To make it easier to add UTM parameters to your links, Dub provides a UTM builder that allows you to easily populate UTM parameters for your links. [Here's a live demo](/tools/utm-builder) that you can play around with.
...
[Read the guide on how to create UTM templates](/help/article/how-to-create-utm-templates) or [try out the demo here](/tools/utm-builder).
