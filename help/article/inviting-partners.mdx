...
og:title: "Inviting partners to your program"
og:description: "Learn how to invite partners to join your affiliate/referral program on Dub Partners"
---
...
<img src="https://assets.dub.co/cms/invite-partner-button-1.png" alt="Merge account button" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/invite-partner-form-2.png" alt="Partner invite form" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/invite-partner-form-edit.png" alt="Partner email invite editor" className="rounded-lg border border-gray-100" />
...
<Tip>
  Want to send these invites using your company email instead for better brandability? [Reach out to support](mailto:support@dub.co) to get early access.
</Tip>
...
<img src="https://assets.dub.co/cms/view-invites-resend.png" alt="" className="rounded-lg border border-gray-100" />
...
- Programmatically adding your apps users to your [in-app referral program](https://dub.co/docs/partners/embedded-referrals)
- Migrating your partners over from another platform like [Rewardful](https://dub.co/help/article/migrating-from-rewardful)

If you're integrating with Dub Partners programatically, you can use our [POST /partners API endpoint](https://dub.co/docs/api-reference/endpoint/create-a-partner) to enroll a partner into your program via our API.

<Warning>
  Before auto-enrolling a partner to your program, make sure to get their consent – either explicitly or via the acceptance of your Terms of Service. Enrolling partners that are unfamiliar with your program is against our [terms of service](/legal/terms).
</Warning>
