...
og:title: "How to add a custom domain to Dub"
og:description: "Set up a custom domain for your Dub workspace easily & for free—no credit card required. Follow our step-by-step guide to get started today!"
---

Whenever you're creating a short link for marketing purposes, it is [important to use a custom domain](/blog/custom-domains) for better brand recognition and click-through rates.

At Dub, we have one of the most generous custom domain limits in the industry – you can add up to 3 custom domains to your workspace for free, and even more with our [paid plans](/pricing).

- [**Pro plan**](/pricing): 10 domains
- [**Business plan**](/pricing): 100 domains
- [**Advanced plan**](/pricing): 250 domains
...
<CheckList>
  ...
  >
    ...
    Alternatively, you can also claim a [complimentary .link custom domain](/help/article/free-dot-link-domain) if you're on a [Pro plan](/help/article/pro-plan) or higher.
...
If you're on a paid plan on Dub ([Pro plan](/pricing) and above), you can claim a [complimentary .link custom domain](/help/article/free-dot-link-domain) and use it as your short link domain – no DNS setup needed.
...
<img src="https://assets.dub.co/cms/add-domain-modal.png" alt="The Add Domain modal in Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/configure-domain.png" alt="Setting up DNS records for your domains on Dub" className="rounded-lg border border-gray-100" />
...
<Warning>
  ...
  Cloudflare domains with Dub](/help/article/using-cloudflare-domains) for
  more information.
</Warning>
...
<img src="https://assets.dub.co/cms/vercel-domain.png" alt="Verifying domain ownership on Dub" className="rounded-lg border border-gray-100" />
