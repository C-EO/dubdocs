...
og:title: "Set Custom Link Previews for Better Branding"
og:description: "Learn how to customize link previews on social media using Dub, improving click-through rates & ensuring consistent branding."
---
...
Dub.co is the only link management platform that lets you customize the social media cards for your links, so you can have full control over how your links look when shared on social media and improve click-through rates.
...
<img src="https://assets.dub.co/help/custom-link-previews.png" alt="Create custom link previews for your links" className="rounded-lg border border-gray-100" />
...
Behind the scenes, [Dub AI](/blog/introducing-dub-ai) leverages the latest Large Language Models (LLMs) to analyze the content of the link and generate a title and description that is SEO-friendly and increases the click-through rate.
...
<img src="https://assets.dub.co/help/causal-yc-tweet.png" alt="Causal's YC dashboard tweet" className="rounded-lg border border-gray-100" />
...
To set a custom video preview, you can pass a link to your video via the `video` attribute when [creating a link](/docs/api-reference/endpoint/create-a-new-link) using our API:
...
<Info>
  ...
  dashboard, but please [let us
  know](/contact/support)
  if that's something that you'd like to see.
</Info>
...
<Video src="https://assets.dub.co/help/custom-video-preview-demo.mp4" />
...
If you're still having issues, please [let us know](/contact/support) and we'll be happy to help you out.
