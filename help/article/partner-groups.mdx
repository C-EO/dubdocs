...
| Group ID    | This non-editable item is used for embedding the Dub white-labeled referral dashboard within your app. [Learn more](/docs/partners/white-labeling).                                                                                                                                                          |
