...
og:title: "Managing your partners with groups"
og:description: "Learn how you can create partner groups to segment partners by rewards, discounts, performance, location, and more."
---
...
<img src="https://assets.dub.co/cms/partner-groups.jpg" alt="Partner Groups" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-navigation-1.png" alt="Group navigation" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-default.png" alt="Default group" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-create.png" alt="Create group" className="rounded-lg border border-gray-100" />
...
| Group ID    | This non-editable item is used for embedding the Dub white-labeled referral dashboard within your app. [Learn more](https://dub.co/docs/partners/white-labeling).                                                                                                                              |
...
<img src="https://assets.dub.co/cms/group-rewards-1.png" alt="Group rewards" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-discounts.png" alt="Group discounts" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-settings-page.png" alt="Group settings" className="rounded-lg border border-gray-100" />
### Group Name
...
### Group ID
When setting up the [Dub embedded referral dashboard](/help/article/dub-partners#embedded-referral-dashboard), you'll use this group ID. The ID cannot be changed.
...
<img src="https://assets.dub.co/cms/move-group.png" alt="Example group move settings" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-applications-table.png" alt="Applications table" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-application-selectgroup.png" alt="Select group" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/group-all-partners.png" alt="All partners" className="rounded-lg border border-gray-100" />
