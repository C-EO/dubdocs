...
<img src="https://assets.dub.co/help/dub-link-builder.jpg" alt="Create a link with the Dub link builder" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/password-section.png" alt="Entering a password for the link" className="rounded-lg border border-gray-100" />

Then, when you share your link, the user will be prompted to enter a password before they can access the destination URL.

<img src="https://assets.dub.co/help/password-protected-page.png" alt="An example of a password-protected page" className="rounded-lg border border-gray-100" />
...
On the [Pro plan](/help/article/pro-plan) and above, you can also set a custom logo for the password page. This is useful if you want to brand the password page with your company's logo.
...
<img src="https://assets.dub.co/help/workspace-logo-section.png" alt="Workspace Logo section" className="rounded-lg border border-gray-100" />

Once you've set your workspace's logo, your password page will automatically update to use your workspace's logo.

<img src="https://assets.dub.co/changelog/improved-password-links.png" alt="Password page with custom logo" className="rounded-lg border border-gray-100" />
