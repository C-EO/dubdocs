...
og:title: "How to transfer links between workspaces?"
og:description: "Learn how to transfer your Dub default short links from one workspace to another."
---
...
<img src="https://assets.dub.co/help/link-transfer-dropdown.png" alt="Transfer link option" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/changelog/transfer-links.png" alt="Transfer link modal" className="rounded-lg border border-gray-100" />
