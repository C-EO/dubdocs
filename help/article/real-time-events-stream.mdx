---
title: "Dub's Real-time Events Stream"
...
og:title: "Dub's Real-time Events Stream"
og:description: "Learn more about Dub's real-time events stream feature and how you can use it to gain deeper insights into your engagement data."
---

<Tip>
  This feature is only available on [Dub's Business
  plan](/help/article/business-plan) and above.
</Tip>
...
<img src="https://assets.dub.co/blog/events-stream-dashboard.jpg" alt="The Events Stream dashboard on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/blog/events-view-button.png" alt="Quick link to open-up the events stream from the Analytics tab" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/blog/events-column-picker.jpg" alt="Selecting which columns to be displayed in the Events table" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/blog/events-filtering.png" alt="Filtering the events stream by link" className="rounded-lg border border-gray-100" />

Once you've filtered the events to your liking, you can export them by clicking `⋮` button and selecting **Download as CSV**.

<img src="https://assets.dub.co/blog/events-export.png" alt="Exporting the filtered events stream to CSV" className="rounded-lg border border-gray-100" />
