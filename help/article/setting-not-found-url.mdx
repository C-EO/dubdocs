...
og:title: "Set a Not Found URL for Custom Domains"
og:description: "Customize your \"not found\" URL on Dub and redirect visitors seamlessly."
---
...
<img src="https://assets.dub.co/changelog/not-found-support.jpg" alt="Placeholder 404 page on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/set-not-found-url-for-domain.png" alt="Setting a not found URL for a custom domain" className="rounded-lg border border-gray-100" />
