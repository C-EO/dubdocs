...
description: "Learn more about what a \"Tag\" is and how you can use it to better manage your links on Dub."
og:title: "How to use Tags on Dub"
og:description: "Easily organize & manage your links with tags on Dub. Learn how to use tags effectively to streamline your workflow & track your content."
---
...
<img src="https://assets.dub.co/changelog/new-tag-creation-flow.png" alt="Using tags to organize links on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/tags-settings-page.png" alt="Tags settings page" className="rounded-lg border border-gray-100" />

Click on **Create Tag** to open up the tag creation modal, where you can create a new tag and choose a color for it:

<img src="https://assets.dub.co/help/create-tag-modal.png" alt="Tag creation modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/tag-dropdown.png" alt="Input the name of the tag you want to create (e.g. 'New Tag')" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/tags-settings-page-edit.png" alt="Editing tags in the Tags settings page" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/tag-menu-dropdown.png" alt="Edit a tag by clicking on the ⋮ icon" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/edit-tag-modal.png" alt="Tag editing modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/multiple-tags-dropdown.png" alt="Assign multiple tags to a link" className="rounded-lg border border-gray-100" />

The tags will show up in the link's details, and you can filter your links by these tags.

<img src="https://assets.dub.co/help/multiple-tags-link.png" alt="Multiple tags assigned to a link" className="rounded-lg border border-gray-100" />
...
- [**Pro plan**](/help/article/pro-plan): Up to 25 tags
- [**Business plan**](/help/article/business-plan): Unlimited tags
- [**Enterprise plan**](/enterprise): Unlimited tags
...
- [Create a New Tag](/docs/api-reference/endpoint/create-a-new-tag)
