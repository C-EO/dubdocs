...
<img
  src="https://assets.dub.co/cms/partner-payouts-location.png"
...
<img
  src="https://assets.dub.co/cms/payouts-table.png"
  alt="Payouts table"
  className="rounded-lg border border-gray-100"
/>
...
<Info>
  ...
  integration](https://dub.co/docs/conversions/sales/stripe), any refunds that
  happen on Stripe will be automatically detected by Dub and the [corresponding
  commission will also be marked as
...
<img
  src="https://assets.dub.co/cms/program-payout-settings.png"
