...
3. **White-labeling**: You can [embed a white-labeled referral dashboard into your application](/docs/partners/white-labeling) for a better user experience.
...
Next, [set up conversion tracking](/docs/partners/quickstart) to track signup and sale events. We also have some [in-app guides that you can reference here](https://app.dub.co/guides).
...
Once you've [set up your Dub partner program](/docs/partners/quickstart#step-3%3A-set-up-your-partner-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from Rewardful".
