...
og:title: "Migrating from Rewardful"
og:description: "Easily migrate your affiliate program from Rewardful to Dub Partners in just a few clicks."
---

import { ImageLink } from "/snippets/image-link.jsx";

<Tip>
  Dub Partners is only available on [Business plans and above](/pricing/partners).
</Tip>
...
**This is where [Dub Partners](/partners) comes in.**
1. **Payouts you can rely on:** We let you [pay your partners globally](https://dub.co/help/article/partner-payouts) in 1-click, with tax compliance built-in, so you can have peace of mind knowing that all payouts are completed successfully.
2. **Advanced reward structures**: On Dub, you can choose between [3 reward types](https://dub.co/help/article/partner-rewards#configuring-reward-types) – per click, per lead, and per sale (flat/percentage). You can also set different [reward conditions](https://dub.co/help/article/partner-rewards#adding-reward-conditions) (e.g., a higher reward for customers based in the U.S. vs other countries) and create [bounties](https://dub.co/help/article/program-bounties) to provide additional rewards for your affiliates.
3. **White-labeling**: You can [embed a white-labeled referral dashboard into your application](https://dub.co/docs/partners/white-labeling) for a better user experience.
...
<Info>
Case in point: [Tella](https://partners.dub.co/tella) migrated their affiliate program from Rewardful to Dub and saw a [38% increase in revenue and 2x more partner signups](/customers/tella).
...
Next, [set up conversion tracking](https://dub.co/docs/partners/quickstart) to track signup and sale events. We also have some [in-app guides that you can reference here](https://app.dub.co/guides).

For backward compatibility, we also recommend setting up [client-side click-tracking](https://dub.co/docs/sdks/client-side/features/click-tracking) when installing the [client-side `@dub/analytics` SDK](https://dub.co/docs/sdks/client-side/introduction) on your site. This will ensure all your existing `domain.com?via=affiliate` links will keep working as expected, which gives affiliates time to update their links to the new format.

You can [follow our guide](https://dub.co/docs/sdks/client-side/features/click-tracking) on how to set up client-side click-tracking for your Dub short links to set that up.
</Step>
...
<img src="https://assets.dub.co/cms/rewardful-api-secret.png" alt="Rewardful API secret" className="rounded-lg border border-gray-100" />
...
Once you've [set up your Dub partner program](https://dub.co/docs/partners/quickstart#step-3%3A-set-up-your-partner-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from Rewardful".
...
<img src="https://assets.dub.co/cms/import-rewardful-modal.png" alt="Import Rewardful modal" className="rounded-lg border border-gray-100" />
...
<Tip>
If you have multiple campaigns on Rewardful, you can [import multiple campaigns](#migrating-multiple-campaigns) into Dub as well.
</Tip>
...
- `Refunded`: When the sale for the commission was refunded. With our [Stripe integration](https://dub.co/docs/conversions/sales/stripe), this is automatically detected and updated.
...
<img src="https://assets.dub.co/cms/import-from-rewardful.png" alt="Import from Rewardful" className="rounded-lg border border-gray-100" />
...
Dub Partners supports [1-click payouts](https://dub.co/help/article/partner-payouts) to partners all across the globe.
...
> Hey,
> 
> Starting today, we are switching the [Your Company] Affiliate Program from Rewardful to [Dub Partners](https://dub.partners/). 
> 
...
Ready to take your affiliate program to the next level? [Sign up today](https://app.dub.co/register) and join companies like [Anara](https://partners.dub.co/anara), [Tella](/customers/tella), and [Testimonial](https://x.com/damengchen/status/1909828612083401028), who have migrated from Rewardful to Dub.

Have any questions? Feel free to [reach out to us](/contact)!
