...
og:title: "Configuring SAML SSO with Azure AD"
og:description: "For Dub Enterprise users, you can securely manage your team's access to Dub using Azure AD SAML SSO."
---
...
<img src="https://assets.dub.co/help/azure-ad.png" alt="Azure Active Directory option on the Azure Dashboard" className="rounded-lg border border-gray-100" />

Then, click on **Enterprise applications** from the left sidebar.

<img src="https://assets.dub.co/help/azure-ent-apps.png" alt="Enterprise applications option on the Azure Dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-new-app.png" alt="Create new application button on the Azure Dashboard" className="rounded-lg border border-gray-100" />

In the next screen, click on **Create your own application**. Give your application a **Name** (e.g. "Dub") and click **Create**.

<img src="https://assets.dub.co/help/azure-create-own.png" alt="Create your own application option on the Azure Dashboard" className="rounded-lg border border-gray-100" />

## Step 2: Configure SAML Application

Under the **Manage** section in the left sidebar, select **Single sign-on**. Then, click on **SAML**.

<img src="https://assets.dub.co/help/azure-saml.png" alt="SAML option on the Azure Dashboard" className="rounded-lg border border-gray-100" />

Under the **Basic SAML Configuration** section, click on **Edit**.

<img src="https://assets.dub.co/help/azure-saml-edit.png" alt="Edit button on the SAML Settings page on the Azure Dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-basic-saml.png" alt="Basic SAML Configuration section on the Azure Dashboard" className="rounded-lg border border-gray-100" />

Click **Save** in the menu bar to save your changes.

<img src="https://assets.dub.co/help/azure-save-saml.png" alt="Basic SAML Configuration section on the Azure Dashboard" className="rounded-lg border border-gray-100" />

## Step 3: Attribute Mapping

Click **Edit** on the **Attributes & Claims** section.

<img src="https://assets.dub.co/help/azure-attributes.png" alt="Attributes & Claims section on the Azure Dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-attributes-claims.png" alt="Additional claims section on the Azure Dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-metadata-url.png" alt="Metadata URL on the Azure Dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/saml-entra.png" alt="SAML SSO Modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-add-users.png" alt="Adding users in Azure AD" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/azure-scim-assign-user.png" alt="Assigning users in Azure AD" className="rounded-lg border border-gray-100" />
