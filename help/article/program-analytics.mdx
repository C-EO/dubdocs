---
title: "Measuring program performance with Dub Analytics"
description: "Learn about how you can use Dub Analytics to better understand your program performance."
og:title: "Measuring program performance with Dub Analytics"
og:description: "Learn about how you can use Dub Analytics to better understand your program performance."
---
...
On any given day, Dub tracks upwards of **5 million clicks, [conversion](/help/article/dub-conversions), and [commission](/help/article/partner-commissions) events.**
...
<img src="https://assets.dub.co/cms/program-analytics-location.png" alt="Program analytics location" className="rounded-lg border border-gray-100" />
## Program analytics views
Your program analytics dashboard consists of several views:
1. [Analytics chart](#analytics-chart)
2. [Partner data table](#partner-data-table)
3. [Aggregated data for different facets (top views)](#aggregated-data-for-different-facets-top-views)
### 
<Steps>
<Step title="Analytics chart">
...
<img src="https://assets.dub.co/cms/program-analytics-timechart-1.png" alt="Time-series chart" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/program-analytics-partnertable-revenue.png" alt="Partner data table" className="rounded-lg border border-gray-100" />

</Step>

<Step title="Aggregated data for different facets (top views)">
...
<img src="https://assets.dub.co/cms/program-analytics-filter.png" alt="Filtering" className="rounded-lg border border-gray-100" />
| Filter | Description |
| ---- | ---- |
| Ask AI | Use natural language to query your analytics - eg:  "mobile chrome users US only", "UK android users" |
| Group | Select a specific [partner group](/help/article/partner-groups) |
| Partner | Select a specific [program partner](/help/article/managing-program-partners) |
