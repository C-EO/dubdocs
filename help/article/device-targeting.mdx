---
title: "How to use device targeting on Dub.co?"
description: "Learn how to use device targeting on Dub.co to personalize the destination URL for your links based on the user's device type."
og:title: "How to use device targeting on Dub.co?"
og:description: "Learn how to use device targeting on Dub.co to personalize the destination URL for your links based on the user's device type."
---
...
<img src="https://assets.dub.co/help/device-targeting.png" alt="Use device targeting to personalize your link's behavior based on the user's device type" className="rounded-lg border border-gray-100" />
