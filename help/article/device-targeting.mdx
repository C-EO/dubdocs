...
og:title: "How to use device targeting on Dub?"
og:description: "Learn how to use device targeting on Dub to personalize the destination URL for your links based on the user's device type."
---
