...
<Warning>
  ...
  won't be tracking correctly. [Learn more
  here.](https://dub.co/docs/partners/quickstart)
</Warning>
...
<Tip>
  We recommend using short links for several reasons: 1. Some web browsers block
  [client-side click
  tracking](https://dub.co/docs/sdks/client-side/features/click-tracking), which
  breaks attribution – with `getacme.link/john` the click will be tracked
  server-side too, which improves attribution accuracy 2. Some web browsers drop
  query params, which breaks attribution as well 3. It's cleaner ✨
</Tip>
...
<img
  src="https://assets.dub.co/cms/link-utm.png"
  alt="Link UTM"
  className="rounded-lg border border-gray-100"
/>
#### When you update a group’s [UTM
template](/help/article/how-to-create-utm-templates), all partner links in the
