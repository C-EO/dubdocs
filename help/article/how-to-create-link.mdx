...
og:title: "How to create a short link on Dub?"
og:description: "Generate & track short links on Dub in minutes. Follow our guide to create your first link & start analyzing your click data effortlessly."
---
...
<Steps>
  ...
  <Step title="Set a short link slug" optional>
    ...
    3. [Generate a short link slug with AI](/blog/introducing-dub-ai).
  ...
  <Step title="Add tags to your short link" optional>
    ...
    <img src="https://assets.dub.co/help/multiple-tags-dropdown.png" alt="Fun fact: You can assign multiple tags to a given Dub link" className="rounded-lg border border-gray-100" />
