...
<img
  src="https://assets.dub.co/cms/folders-rbac.png"
  alt="Folders RBAC"
...
<img
  src="https://assets.dub.co/cms/folders-action-member-option.png"
  alt="Folders member option"
  className="rounded-lg border border-gray-100"
/>
...
<img
  src="https://assets.dub.co/cms/folder-members-rbac.png"
  alt="Folders member option"
  className="rounded-lg border border-gray-100"
/>
...
<Tip>
  ...
  users](https://dub.co/docs/api-reference/tokens#machine-users) for your
  API/integrations, remember to assign them the correct folder permissions as
  well – they function the same way as regular users and would require the
...
<img
  src="https://assets.dub.co/cms/request-edit-folder.png"
  alt="Request edit access folder"
  className="rounded-lg border border-gray-100"
/>
...
<img
  src="https://assets.dub.co/cms/folder-access-request-email.png"
  alt="Folder access request email"
  className="rounded-lg border border-gray-100"
/>
