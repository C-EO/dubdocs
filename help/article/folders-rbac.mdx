...
og:title: "Folders role-based access control (RBAC)"
og:description: "Learn how to set role-based access control for your folders to limit access to links for select teammates."
---
...
<img src="https://assets.dub.co/cms/folders-rbac.png" alt="Folders RBAC" className="rounded-lg border border-gray-100" />
...
<Tip>
If you're on the [Pro plan](https://dub.co/pricing), you can only create folders with the default **"Can edit"** settings. Only [Business plan](https://dub.co/pricing) and above users can create folders with the **"Can view"** or **"No access"** settings.
</Tip>
...
<img src="https://assets.dub.co/cms/folders-action-member-option.png" alt="Folders member option" className="rounded-lg border border-gray-100" />

This will open up the member access control panel, where you can set different roles to different users:



<img src="https://assets.dub.co/cms/folder-members-rbac.png" alt="Folders member option" className="rounded-lg border border-gray-100" />
...
<Tip>
If you are using [machine users](https://dub.co/docs/api-reference/tokens#machine-users) for your API/integrations, remember to assign them the correct folder permissions as well – they function the same way as regular users and would require the correct permissions to be able to perform actions within a folder.
</Tip>
...
<img src="https://assets.dub.co/cms/request-edit-folder.png" alt="Request edit access folder" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/folder-access-request-email.png" alt="Folder access request email" className="rounded-lg border border-gray-100" />
