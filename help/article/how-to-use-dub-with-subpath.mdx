...
description: "Learn how to configure Dub.co to handle redirects on a subpath of an existing domain."
og:title: "How to use Dub to shorten links on a subpath"
og:description: "Configure to handle redirects on a subpath of your domain. Follow our guide to set up seamless & efficient URL redirection."
---
...
You can follow [these steps](/help/article/how-to-add-custom-domain#step-2b-adding-a-subdomain) to add a subdomain to Dub.co.
...
<img src="https://assets.dub.co/help/url-rewrites-example.png" alt="URL Rewrites example" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/cloudflare-redirect-rules.png" alt="Cloudflare Redirect Rules example" className="rounded-lg border border-gray-100" />
