...
og:title: "How to filter analytics by tags"
og:description: "Use tags in Dub Analytics to create campaign-specific reports. Filter link data easily & track performance with precision."
---
...
<img src="https://assets.dub.co/help/analytics-tags-dropdown.png" alt="Analytics tags filter" className="rounded-lg border border-gray-100" />

    </Step>
    <Step title="Click on the tag you want to filter by">
        Finally, click on the tag you want to filter by:

        <img src="https://assets.dub.co/help/filtered-analytics-by-tags.png" alt="Filtered analytics by tags" className="rounded-lg border border-gray-100" />
    </Step>
    ...
    <Step title="Optional: Filter by multiple tags">
        ...
        <img src="https://assets.dub.co/help/filtered-analytics-by-multiple-tags.png" alt="Filtered analytics by multiple tags" className="rounded-lg border border-gray-100" />
    </Step>
