...
| Submission type | This is the criteria for which partners will submit their entry. Select between manual submission or social metrics. |
| Reward | The reward amount the partner will receive upon completing the bounty. |
| Groups                  | [Partner group](/help/article/partner-groups) eligibility. The same bounty can be applied to multiple [partner groups](/help/article/partner-groups) – or all groups in your program. |
...
Manual submission is best used for when you want to reward for specific actions or achievements from your partners, such publishing a blog post highlighting your product or hosting an event (in-person or online) promoting your brand.
...
<Frame>
  <img
    src="/images/dub-partners/allowed-domains.png"
    alt="Allowed domains"
  />
</Frame>
...
Social metric submissions are best used for when you want to reward for social content post performance from your partners. Their performance is automatically tracked and measured against your set criteria.

When submitting these bounties, the partner can only provide one link, and it's required to be from a verified account on their profile.

<Frame>
  <img
    src="/images/dub-partners/social-metric-empty.png"
    alt="Social metric variable"
  />
</Frame>

#### Social channels

You can track performance on one social channel per bounty, and can select from:
...
And for each social channel, you can track either likes or views.
