...
og:title: "What are default Dub domains?"
og:description: "Learn more about the default branded domains provided by Dub and how you can use them to share your links."
---
...
Dub also offers a premium `dub.link` domain for [Pro users](/help/article/pro-plan) and above. Since it's only available on our paid plans, it's much more exclusive than our free [dub.sh](https://dub.sh) short domain.

<img src="https://assets.dub.co/blog/dub-link.jpg" alt="Dub.link" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/enable-dub-link.jpg" alt="Enable dub.link domain" className="rounded-lg border border-gray-100" />
...
| **Branding**   | Dub.co branding on the short link                                 | Your own branding on the short link                                                                                             |
