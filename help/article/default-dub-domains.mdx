...
import { DefaultDomainsSlider } from "/snippets/default-domains-slider.jsx";
...
<img
  src="https://assets.dub.co/blog/dub-link.jpg"
  alt="Dub.link"
...
<img
  src="https://assets.dub.co/help/enable-dub-link.jpg"
  alt="Enable dub.link domain"
  className="rounded-lg border border-gray-100"
/>
