...
sidebarTitle: "Receiving payouts"
---
...
<Tip>
  ...
  can try the following: - refer to the official [Stripe Express help
  articles](https://support.stripe.com/express) - reach out to [Stripe Express
  support](https://support.stripe.com/?contact=true) - reach out to [Dub
