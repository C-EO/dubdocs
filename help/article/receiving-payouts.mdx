...
og:title: "Receiving partner payouts on Dub"
og:description: "Learn how to connect a bank account and start receiving partner payouts from the affiliate programs you're working with."
---
...
<Info>
**Your payout bank account must match your local currency for compliance reasons.** E.g. if you're based in the UK, you will need to connect a GBP bank account to receive payouts. 
<br/>
...
<img src="https://assets.dub.co/cms/partner-payout-settings.png" alt="partner payout settings" className="rounded-lg border border-gray-100" />
...
<Tip>
While Stripe itself might not be supported in certain countries, we use [Stripe Express](https://support.stripe.com/express) for payouts, which [covers most regions worldwide](https://docs.stripe.com/connect/cross-border-payouts#supported-countries). Example: you can still receive payouts in India, even though Stripe itself is not available in India.
</Tip>
...
<img src="https://assets.dub.co/cms/update-partner-profile.png" alt="update partner profile" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/pay out now $10.png" alt="Pay Out Now Button" className="rounded-lg border border-gray-100" />
