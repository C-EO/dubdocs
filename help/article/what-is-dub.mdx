---
title: "What is Dub?"
description: "How Dub works, what it can do for your business and what makes it different to other solutions."
og:title: "What is Dub?"
og:description: "Discover how Dub simplifies link management. Learn its key features, benefits & what sets it apart from other solutions."
---

import { ImageLink } from "/snippets/image-link.jsx";

Dub is the open-source link management platform for modern marketing teams. With Dub, you can [create short links](/help/article/how-to-create-link) using your own [custom domain](/help/article/how-to-add-custom-domain) and get [world-class analytics](/help/article/dub-analytics) on your links' performance.
...
<img src="https://assets.dub.co/help/dub-link-builder.jpg" alt="The Dub link builder" className="rounded-lg border border-gray-100" />
...
On Dub, you can create short links with your own [custom domain](/help/article/how-to-add-custom-domain) – for [better brand recognition](/blog/custom-domains).

We also have one of the most generous custom domain limits in the industry – you can add up to 3 custom domains to your workspace for free, and even more with our [paid plans](/pricing).

- [**Pro plan**](/help/article/pro-plan): 10 domains
- [**Business plan**](/help/article/business-plan): 40 domains
- [**Enterprise plan**](/enterprise): Unlimited domains
...
QR codes and short links are like peas in a pod. That's why we've built a [QR code generator](/tools/qr-code) right into Dub that lets you generate branded QR codes for your links.
...
On Dub [Enterprise](/enterprise), you can also set up [SAML/SSO and SCIM Directory Sync](/help/category/saml-sso) for greater security and control.
...
Our API is used in production by engineering teams at companies like [Raycast](/customers/raycast), [Whop](https://whop.com), and [Midday](/customers/midday).
...
Dub is perfect for modern marketing teams that want a better link management platform for their marketing campaigns.
...
You can check out a full list of our customers on our [customers page](/customers).
...
- [Dub vs Bitly](/compare/bitly)
- [Dub vs Rebrandly](/compare/rebrandly)
- [Dub vs Short.io](/compare/short)
