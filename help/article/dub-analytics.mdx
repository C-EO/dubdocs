...
og:title: "Dub Analytics Overview"
og:description: "Learn how to use Dub Analytics to understand your audience, track engagement, & optimize your link performance effectively."
---
...
<img src="https://assets.dub.co/cms/timeseries-analytics-01.png" alt="Time-series line chart" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/aggregated-analytics-facets-01.png" alt="Aggregated data for different facets" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/events-stream-dashboard-01.png" alt="The Events Stream dashboard on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/events-view-button-01.png" alt="Quick link to open-up the events stream from the Analytics tab" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/date-range-picker-01.png" alt="New Date Range Picker for custom date ranges" className="rounded-lg border border-gray-100" />
...
Additionally, with [Dub Partners](/partners), you can also filter by the following:
...
<img src="https://assets.dub.co/cms/advanced-filters-is.png" alt="Advanced filters IS" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/advanced-filters-is-not.png" alt="Advanced filters IS NOT" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/advanced-analytics-filters.jpg" alt="Mix and match analytics filters" className="rounded-lg border border-gray-100" />

This is available for both [Dub Partners](/partners) & [Dub Links](/links), and you can filter across [all of the facets mentioned above](#filtering-data).
...
<img src="https://assets.dub.co/cms/download-csv-button-01.png" alt="Click on the download icon to export the data" className="rounded-lg border border-gray-100" />
...
- "UK android users"
- "[filter for new sales only](/changelog/filter-sale-type) last 30 days"

And [Dub AI](/blog/introducing-dub-ai) will automatically select the right filters and generate a report for you.
