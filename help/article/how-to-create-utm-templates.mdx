...
og:title: "How to create UTM templates on Dub"
og:description: "Simplify UTM tracking with custom templates on Dub. Learn how to create, manage & apply UTM parameters efficiently across campaigns."
---
...
<Tip>
Learn more about the best practices when it comes to UTM tracking with our [Ultimate Guide to UTM Tracking](https://dub.co/blog/utm-guide).
</Tip>
...
<img src="https://assets.dub.co/help/utm-builder.png" alt="Use the UTM builder to populate UTM parameters for your links" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-templates-dropdown.png" alt="The UTM templates dropdown" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-templates-settings.png" alt="The UTM templates settings page" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-template-modal.png" alt="The UTM template editor" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-template-entry.png" alt="A UTM template entry in the UTM templates list" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-templates-shortcut.png" alt="UTM icon in the link builder" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/utm-templates-dropdown-select.png" alt="Selecting a UTM template from the dropdown" className="rounded-lg border border-gray-100" />
