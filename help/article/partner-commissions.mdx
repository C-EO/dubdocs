...
If you've already [connected to Stripe](/docs/conversions/sales/stripe#stripe), you can import your customer by clicking on **Import from Stripe**. This will allow you to search existing Stripe customers by their email, and click to import their details into Dub.
