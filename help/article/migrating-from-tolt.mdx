...
og:title: "Migrating from Tolt"
og:description: "Easily migrate your affiliate program from Tolt to Dub Partners in just a few clicks."
---
...
1. **Comprehensive analytics**: Dub offers [powerful real-time analytics](https://dub.co/analytics), including [conversion tracking](https://dub.co/help/article/dub-conversions), device, browser, referrer, country, and more. Our [AI feature](https://dub.co/help/article/dub-analytics#bonus-ask-ai-feature) makes filtering data intuitive and quick.
2. **Payouts you can rely on:** We let you [pay your partners globally](https://dub.co/help/article/partner-payouts) in 1-click, with tax compliance built-in, so you can have peace of mind knowing that all payouts are completed successfully.
...
4. **Advanced reward structures**: On Dub, you can choose between [3 reward types](https://dub.co/help/article/partner-rewards#configuring-reward-types) – per click, per lead, and per sale (flat/percentage). You can also set different [reward conditions](https://dub.co/help/article/partner-rewards#adding-reward-conditions) (e.g., a higher reward for customers based in the U.S. vs other countries) and create [bounties](https://dub.co/help/article/program-bounties) to provide additional rewards for your affiliates.
...
<img src="https://assets.dub.co/cms/tolt-api-key.png" alt="Tolt API key" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/tolt-program-id.png" alt="Tolt Program ID" className="rounded-lg border border-gray-100" />
...
Once you've [set up your Dub partner program](https://dub.co/docs/partners/quickstart#step-3%3A-set-up-your-partner-program), go to your [Partners tab](https://app.dub.co/program/partners), click on the `⋮` button and select "Import from Tolt".
...
<img src="https://assets.dub.co/cms/import-tolt-modal.png" alt="Import Tolt modal" className="rounded-lg border border-gray-100" />
...
Learn more about how [Partner rewards](https://dub.co/help/article/partner-rewards) work on Dub.
</Info>
...
- `Processed`: When a commission has been added to a [payout](https://dub.co/help/article/partner-payouts) (after any applicable holding period).
...
> Hey,
> 
> Starting today, we are switching the [Your Company] Affiliate Program from Tolt to [Dub Partners](https://dub.partners/). 
> 
