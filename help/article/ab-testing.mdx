...
/>
## A/B testing builder With the builder open, you are able to add additional
destination URLs, set the traffic percentage, and set the completion date. A
minimum of 2 URLs is required to create the test.
<img
  src="https://assets.dub.co/cms/ab-dialog.png"
  alt="A/B test builder"
  className="rounded-lg border border-gray-100"
/>
### Testing URLs You can enter a maximum of 4 additional testing URLs that you'd
like to send your traffic to.
<img
  src="https://assets.dub.co/cms/ab-urls.png"
  alt="Testing URLs"
  className="rounded-lg border border-gray-100"
/>
If you need to remove any URLs you've added, click the **`X`** icon to the right
of each input to remove it.
...
<img
  src="https://assets.dub.co/cms/ab-link-icon-2.png"
  alt="Links view"
  className="rounded-lg border border-gray-100"
/>
...
<img
  ...
  className="rounded-lg border border-gray-100"
/>
## Completing A/B tests There are two ways A/B tests can be completed. They can
either be manually ended early or the scheduled completion date passes.
...
<img
  src="https://assets.dub.co/cms/ab-complete-2.png"
  alt="End test early"
  className="rounded-lg border border-gray-100"
/>
