...
og:title: "Configuring partner rewards"
og:description: "Learn how to create custom rewards (pay-per-click, pay-per-lead, pay-per-sale) tailored to each partner with Dub Partners."
---
...
On [Dub Partners](https://dub.co/help/article/dub-partners), you can offer different incentives for your partners to incentivize them to create high-quality content to spread the word about your product:
...
<img src="https://assets.dub.co/cms/group-rewards-default.png" alt="Default group rewards" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/reward-create-intial-01.png" alt="Initial create sale reward state" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/create-reward-condition-02.png" alt="Initial create sale reward state" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/create-reward-condition-filled-02.png" alt="Initial create sale reward state" className="rounded-lg border border-gray-100" />

<Tip>
  Customizing reward conditions is only available on the [Advanced plan and above](/pricing/partners).
</Tip>
...
<img src="https://assets.dub.co/cms/custom-desc-01.png" alt="Custom reward description" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/custom-desc-02.png" alt="Editing the reward description" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/custom-desc-03.png" alt="Editing the reward tooltip" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/custom-desc-04.png" alt="Reward preview tooltip hover" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/reward-preview-01.png" alt="Reward preview" className="rounded-lg border border-gray-100" />

## Reward examples
Here are a few reward examples with their conditions to give you some starting ideas.
<Steps>
<Step title="Geo-specific">
When your partners have conversions from specific countries, reward them with a higher percentage.

<img src="https://assets.dub.co/cms/condition-example-01.png" alt="Global Boost condition example" className="rounded-lg border border-gray-100" />
...
<Step title="Product spotlight">
Tailor your reward amount by product. In this example, we're rewarding more when the sale is for the Gold Plan.

<img src="https://assets.dub.co/cms/condition-example-02.png" alt="Product Spotlight condition example" className="rounded-lg border border-gray-100" />
...
<br/>
If you're manually tracking a sale event via our `/track/sale` endpoint, you can pass along the product ID via the [metadata prop](https://dub.co/docs/api-reference/endpoint/track-sale#body-metadata) (e.g. `metadata.productId = "prod_xxx"`).
</Info>

</Step>

<Step title="Partner performance tiers">
...
<img src="https://assets.dub.co/cms/condition-example-03.png" alt="The Climb condition example" className="rounded-lg border border-gray-100" />

**Condition #1** 

If `Partner` `Total conversions` `is greater than or equal to` `100`

**Condition #2**

If `Partner` `Total conversions` `is greater than or equal to` `200`


</Step>

<Step title="Sale reward tiers">
...
<img src="https://assets.dub.co/cms/condition-example-04.png" alt="The Climb condition example" className="rounded-lg border border-gray-100" />
...
<Step title="Staggered reward tiers">
When you want to offer a different reward amount after the customer's subscription meets a specific time period. 

<img src="https://assets.dub.co/cms/staggered-rewards-03.png" alt="Staggered rewards example" className="rounded-lg border border-gray-100" />
