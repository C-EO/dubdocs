...
description: "Learn how you can use Dub's Conversion Analytics feature to understand how well your link clicks are converting to revenue."
og:title: "Dub Conversions Overview"
og:description: "Learn how you can use Dub's Conversion Analytics feature to understand how well your link clicks are converting to revenue."
---

import { ImageLink } from "/snippets/image-link.jsx";

<Tip>
  This feature is only available on [Dub Business](/help/article/business-plan)
  and above.
</Tip>
...
With Dub Conversions, you can turn any [short link you create on Dub](/help/article/how-to-create-link) into a full attribution engine. This allows you to understand how well your links are translating to actual users and revenue dollars.

<VideoPlayer
  src="https://assets.dub.co/misc/dub-conversions.mp4"
  aspectRatio="1920/1080"
  thumbnail="https://assets.dub.co/misc/dub-conversions-thumbnail.jpg"
  title="Watch Dub Conversions in action"
...
<img src="https://assets.dub.co/help/conversion-click-event.png" alt="A diagram showing how click events are tracked in the conversion funnel" className="rounded-lg border border-gray-100" />
...
To enable this, you need to [install the `@dub/analytics` package](/docs/sdks/client-side/installation-guides/react) in your project.

<NPMPackage name="@dub/analytics" />
...
<img src="https://assets.dub.co/help/conversion-lead-event.png" alt="A diagram showing how lead events are tracked in the conversion funnel" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/conversion-sale-event.png" alt="A diagram showing how sale events are tracked in the conversion funnel" className="rounded-lg border border-gray-100" />

**Option 1: Stripe integration (recommended)**

At Dub, we have a [native Stripe integration](/docs/conversions/sales/stripe) that you can set up in 2-3 clicks and automatically send sale events to Dub.
...
We also have a [native Shopify integration](/docs/conversions/sales/shopify) that you can install in 2-3 clicks and automatically track sale events with Dub Conversions.

The way the integration works is as follows:

1. Install the [Dub Shopify app](/docs/integrations/shopify) in your Shopify store.
...
<img src="https://assets.dub.co/help/conversions-timeseries-analytics.png" alt="Time-series line chart" className="rounded-lg border border-gray-100" />

- **Funnel chart**: A funnel chart view visualizing the conversion & dropoff rates across the different steps in the conversion funnel (clicks → leads → sales).

<img src="https://assets.dub.co/help/conversions-funnel-chart.png" alt="Funnel chart view showing the conversion & dropoff rates from clicks → leads → sales" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/conversions-events-stream-dashboard.png" alt="The Events Stream dashboard on Dub" className="rounded-lg border border-gray-100" />
...
With [Dub Partners](/partners) (built on top of Dub Conversions), you can track how well your affiliate/referral links are performing and [display the real-time analytics directly inside your application](https://dub.co/docs/partners/white-labeling).

For instance, here's a screenshot of our very own Dub referral program – powered by Dub Conversions – that [lives within the Dub dashboard](https://app.dub.co/referrals):

<img src="https://assets.dub.co/help/dub-referrals-demo.png" alt="A demo of the Dub Referrals dashboard" className="rounded-lg border border-gray-100" />

With Dub's [real-time webhooks feature](/docs/concepts/webhooks/introduction), you can also build custom [dual-sided incentive structures](/help/article/dual-sided-incentives) – e.g. rewarding the referrer an additional 100 credits when a new user signs up with their link.

### 2. Influencer campaigns attribution tracking

You can also use [Dub Partners](/partners) to better [understand the performance of your influencer campaigns](/help/article/program-analytics) – not just the number of clicks, but also the number of signups/purchases.
...
To get started with Dub Conversions, check out our [quickstart guide](/docs/conversions/quickstart).

<ImageLink
  alt="Dub Conversions quickstart guide"
  src="https://assets.dub.co/cms/dub-conversions-quickstart.png"
