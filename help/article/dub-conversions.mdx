...
import { NPMPackage } from "/snippets/npm-package.jsx";
import { VideoPlayer } from "/snippets/video-player.jsx";
...
<img
  src="https://assets.dub.co/help/conversions-funnel-chart.png"
...
With [Dub Partners](https://dub.co/partners) (built on top of Dub Conversions), you can track how well your affiliate/referral links are performing and [display the real-time analytics directly inside your application](https://dub.co/docs/partners/white-labeling).
