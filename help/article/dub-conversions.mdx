...
We also have a [native Shopify integration](/docs/conversions/sales/shopify) that you can install in 2-3 clicks and automatically track sale events with Dub.
...
To get started with conversion tracking on Dub, check out our [quickstart guide](/docs/conversions/quickstart).
