...
<img
  src="https://assets.dub.co/help/connection-not-private.png"
...
<img
  src="https://assets.dub.co/help/microsoft-defender-unsafe.png"
  alt="Microsoft Defender's 'This site has been reported as unsafe' warning"
  className="rounded-lg border border-gray-100"
/>
...
<img
  src="https://assets.dub.co/help/insecure-connection.png"
  alt="'This site cannot provide a secure connection' error"
  className="rounded-lg border border-gray-100"
/>
