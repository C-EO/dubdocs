...
og:title: "Customizing your program application form"
og:description: "Learn how to customize your program application form to collect the right information you need and select the best partners to work with for your program."
---
...
<Tip>
On Dub, you can create a custom application form for each [partner group](/help/article/partner-groups) in your program. This is helpful for collecting different information from different partner types – e.g. influencers vs affiliates vs resellers.
<br />
...
<img src="https://assets.dub.co/cms/program-branding-tab-1.png" alt="Branding page within your dashboard" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-mandatory.png" alt="Mandatory fields" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-edit1.png" alt="Brand page within your dashboard" className="rounded-lg border border-gray-100" />


## Input field types
Click **Insert field** to open the selector, then pick the input type you want to add.

<img src="https://assets.dub.co/cms/application-insertfield2.png" alt="Insert field" className="rounded-lg border border-gray-100" />
### Short text
Use for short answers like names, one-line bios, or URLs.

<img src="https://assets.dub.co/cms/application-shorttext.png" alt="Adding short text fields" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-longtext.png" alt="Adding long text fields" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-dropdown.png" alt="Adding files" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-multiplechoice.png" alt="Adding accordion content" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-imageupload.png" alt="Adding image upload" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-website.png" alt="Adding website and social inputs" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/application-publish.png" alt="Publish button" className="rounded-lg border border-gray-100" />
##
