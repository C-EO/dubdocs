...
og:title: "How to export links from Dub"
og:description: "Export your Dub links to a CSV file quickly & easily. Follow our guide to back up, manage & organize your short link data in just a few steps."
---
...
<Step title="Open the Export links modal">
    ...
    <img src="https://assets.dub.co/help/links-dashboard-dropdown.png" alt="Click on the more options dropdown menu to open the export links modal" className="rounded-lg border border-gray-100" />
...
<Step title="Select the date range">
    ...
    <img src="https://assets.dub.co/changelog/export-links.png" alt="Select the date range for the links you want to export" className="rounded-lg border border-gray-100" />
...
<Step title="Select the columns to export">
    ...
    <img src="https://assets.dub.co/help/export-links-columns.png" alt="Select the columns that you want to export" className="rounded-lg border border-gray-100" />
...
<Step title="Apply current filters" optional>
    ...
    <img src="https://assets.dub.co/help/export-links-columns-with-filters.png" alt="Apply current filters to the links you want to export" className="rounded-lg border border-gray-100" />
