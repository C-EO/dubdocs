...
og:title: "Sending marketing and transactional emails to your partners"
og:description: "Learn how to craft and send marketing and transactional emails to your partners to increase partner engagement and drive conversions."
---
...
<Info>
Sending partner emails with your own domain (e.g. `partners.acme.com`) is not only good for branding, but will also drastically improve deliverability and help avoid the dreaded spam folder.
</Info>
...
<img src="https://assets.dub.co/cms/email-no-domain.png" alt="Email domains" className="rounded-lg border border-gray-100" />

Click **Add domain**, and enter the domain you want to send emails from. 

<img src="https://assets.dub.co/cms/email-domain-modal.png" alt="Add domain modal" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-domain-records-3.png" alt="DNS records" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-domain-active-2.png" alt="Active email domain" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-nav-location.png" alt="Email location" className="rounded-lg border border-gray-100" />

## Creating a new campaign
Click **Create Campaign** in the top-right corner, then select the type of email you want to send.

<img src="https://assets.dub.co/cms/email-create-campaign.png" alt="Create campaign" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-content-marketing.png" alt="Marketing fields" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-content-transactional.png" alt="Transactional fields" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-styles.png" alt="Email styles" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-preview-modal.png" alt="Preview email" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/email-metrics.png" alt="Email metrics" className="rounded-lg border border-gray-100" />
