...
og:title: "How to set a primary domain on Dub?"
og:description: "Discover what a primary domain is on Dub & how to configure it. Follow our step-by-step guide for seamless domain setup."
---

Dub.co is the only link management platform that allows you to [add custom domains](/help/article/how-to-add-custom-domain) for free. On Dub, you can add up to 3 domains on the free plan, and 10+ domains on the [Pro plan](/help/article/pro-plan) and above.
...
<img src="https://assets.dub.co/help/primary-domain-link-creation-modal.png" alt="Primary domain in the Dub link builder" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/domain-popover-menu-primary.png" alt="More options popover" className="rounded-lg border border-gray-100" />

5. Click on the **Set as primary domain** button in the modal.

<img src="https://assets.dub.co/help/primary-domain-modal.png" alt="Set as primary domain modal" className="rounded-lg border border-gray-100" />
