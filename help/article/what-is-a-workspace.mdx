...
og:title: "What is a \"Workspace\" on Dub?"
og:description: "Organize your links effectively with Workspaces on Dub. Learn what a Workspace is & how it helps streamline your link management."
---
...
<img src="https://assets.dub.co/help/workspace-creation-modal.png" alt="The workspace creation modal on Dub" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/help/onboarding-checklist.png" alt="Onboarding checklist for a new workspace in Dub" className="rounded-lg border border-gray-100" />
...
2. **Create or import your links**: You can [create links](/help/article/how-to-create-link) or [import existing ones](/help/category/migrating) to your workspace.
...
<img src="https://assets.dub.co/help/filter-links-by-domain.png" alt="Filtering links by domain in Dub" className="rounded-lg border border-gray-100" />
...
However, to prevent abuse, you can only create up to 2 workspaces on the Free plan. If you need more workspaces, you can [upgrade to the Pro plan](/help/article/pro-plan).
