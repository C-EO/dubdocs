...
og:title: "How to filter analytics by folders"
og:description: "Use folders in Dub Analytics to create campaign-specific reports. Filter link data easily & track performance with precision."
---
...
<Steps>
     ...
     <Step title="Open Analytics filter dropdown">
        ...
        <img src="https://assets.dub.co/cms/analytics-filter-dropdown-folder.png" alt="Analytics filter dropdown folder" className="rounded-lg border border-gray-100" />
...
<img src="https://assets.dub.co/cms/analytics-folder-filter.png" alt="Analytics folder filter" className="rounded-lg border border-gray-100" />

    </Step>
    <Step title="Click on the folder you want to filter by">
        Finally, click on the folder you want to filter by:

        <img src="https://assets.dub.co/cms/filtered-analytics-by-folder.png" alt="Filtered analytics by folder" className="rounded-lg border border-gray-100" />
    </Step>
</Steps>
...
<img src="https://assets.dub.co/cms/view-folder-analytics-shortcut.png" alt="View folder analytics shortcut" className="rounded-lg border border-gray-100" />
---
