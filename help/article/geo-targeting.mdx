...
og:title: "How to use geo targeting on Dub?"
og:description: "Learn how to use geo targeting on Dub to redirect your users to different links based on their location."
---
