...
If you're integrating with Dub Partners programmatically, you can use our [POST /partners API endpoint](/docs/api-reference/partners/create) to enroll a partner into your program via our API.
