...
You can create only one discount per group. To create a discount, click **Create** on the discount block. Learn more about [creating discounts](/docs/partners/link-based-discounts).
