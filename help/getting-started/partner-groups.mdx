...
To create a reward, click **Create** on any of the reward types. Learn more about [creating rewards](/help/customizing-rewards/customizing-rewards).
...
Specify how long your commissions will be held in "pending" status before becoming eligible for payout. [Learn more](/help/sending-payouts/partner-payouts).

### Auto-approve

Enable or disable auto-approving new applicants to this group. [Learn more](/help/recruiting-partners/reviewing-applications).
...
<CardGroup cols={2}>
  ...
  <Card title="Reviewing applications" icon="clipboard-check" href="/help/recruiting-partners/reviewing-applications" />
