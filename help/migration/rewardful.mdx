...
2. **White-labeling:** You can [embed a white-labeled referral dashboard into your application](/docs/partners/embedded-referrals) for a better user experience.
...
For backward compatibility, we also recommend setting up [client-side click-tracking](/docs/sdks/client-side/features/click-tracking) when installing the [client-side @dub/analytics SDK](/docs/sdks/client-side/introduction) on your site. This will ensure all your existing `domain.com?via=affiliate` links will keep working as expected, which gives affiliates time to update their links to the new format.
...
- **Refunded:** When the sale for the commission was refunded. With our [Stripe integration](/docs/conversions/sales/stripe), this is automatically detected and updated.
